Feature: Foreign currency exchange rates api with currency conversion
  ...
  Scenario Outline: API to get the latest the FX data based on base and symbols currencies
    ...
    Examples:
      ...
      | Positive Edge Case - Default base currency & 32 symbol currency excluding EUR                                 |                 | CHF,HRK,MXN,ZAR,INR,THB,CNY,AUD,ILS,KRW,JPY,RUB,PLN,GBP,IDR,HUF,PHP,TRY,HKD,ISK,DKK,MYR,CAD,USD,BGN,NOK,RON,SGD,CZK,SEK,NZD,BRL |
      | Positive Edge Case - Non-Default base currency & 33 symbol currency including EUR                             | MXN             | CHF,HRK,MXN,ZAR,INR,THB,CNY,AUD,ILS,KRW,JPY,RUB,PLN,GBP,IDR,HUF,PHP,TRY,HKD,ISK,DKK,MYR,CAD,USD,BGN,NOK,RON,SGD,CZK,SEK,NZD,BRL,EUR |
      ...
      | Negative Edge Case - Non-Default base currency & 34 symbol currencies where 34th symbol currency is invalid   | ZAR             | CHF,HRK,MXN,ZAR,INR,THB,CNY,AUD,ILS,KRW,JPY,RUB,PLN,GBP,IDR,HUF,PHP,TRY,HKD,ISK,DKK,MYR,CAD,USD,BGN,NOK,RON,SGD,CZK,SEK,NZD,BRL,EUR,XXX |
