Feature: Foreign currency exchange rates api with currency conversion
  ...
  Scenario Outline: API to get the past conversion rate based on base and symbols currencies
    ...
    Examples:
      ...
      | Positive Edge Case - Default base currency & 32 symbol currency excluding EUR with valid date in between today/last working day and 1999  |             | CHF,HRK,MXN,ZAR,INR,THB,CNY,AUD,ILS,KRW,JPY,RUB,PLN,GBP,IDR,HUF,PHP,TRY,HKD,ISK,DKK,MYR,CAD,USD,BGN,NOK,RON,SGD,CZK,SEK,NZD,BRL | 2020-04-12 |
      | Positive Edge Case - Default base currency & 32 symbol currency excluding EUR and valid future date                                       |             | CHF,HRK,MXN,ZAR,INR,THB,CNY,AUD,ILS,KRW,JPY,RUB,PLN,GBP,IDR,HUF,PHP,TRY,HKD,ISK,DKK,MYR,CAD,USD,BGN,NOK,RON,SGD,CZK,SEK,NZD,BRL | 2020-05-09 |
      | Positive Edge Case - Non-Default base currency, 33 symbol currency including EUR and valid date in between today/last working day and 1999| CHF         | CHF,HRK,MXN,ZAR,INR,THB,CNY,AUD,ILS,KRW,JPY,RUB,PLN,GBP,IDR,HUF,PHP,TRY,HKD,ISK,DKK,MYR,CAD,USD,BGN,NOK,RON,SGD,CZK,SEK,NZD,BRL,EUR | 2018-04-12 |
      | Positive Edge Case - Non-Default base currency, 33 symbol currency including EUR and valid future date                                    | CAD         | CHF,HRK,MXN,ZAR,INR,THB,CNY,AUD,ILS,KRW,JPY,RUB,PLN,GBP,IDR,HUF,PHP,TRY,HKD,ISK,DKK,MYR,CAD,USD,BGN,NOK,RON,SGD,CZK,SEK,NZD,BRL,EUR | 2020-06-09 |
      ...
      | Negative - Default base currency, 32 symbol currency excluding EUR and valid date with year 1998                                          |             | CHF,HRK,MXN,ZAR,INR,THB,CNY,AUD,ILS,KRW,JPY,RUB,PLN,GBP,IDR,HUF,PHP,TRY,HKD,ISK,DKK,MYR,CAD,USD,BGN,NOK,RON,SGD,CZK,SEK,NZD,BRL | 1998-05-13 |
